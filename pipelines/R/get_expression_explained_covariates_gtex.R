...
main <- function(cmdArgs = commandArgs(T)) {
    ...
    #covariate_file <- '/scratch/users/paedugar/transcriptome_diversity/PEER_covariates/gtex_Whole_Blood.txt'
    #covariate_file <- '/scratch/users/paedugar/transcriptome_diversity/auxiliary_files/GTEx_Analysis_v8_eQTL_covariates/Whole_Blood.v8.covariates.txt'
    
    #pca_stats_file <- '/scratch/users/paedugar/transcriptome_diversity/var_explained_by_transcriptome_diversity/pca_method/from_raw/tpm/gtex_Muscle_Skeletal/PC_stats.txt'
    #pca_loadings_file <- '/scratch/users/paedugar/transcriptome_diversity/var_explained_by_transcriptome_diversity/pca_method/from_raw/tpm/gtex_Muscle_Skeletal/PC_matrix.txt'
    #covariate_file <- '/scratch/users/paedugar/transcriptome_diversity/PEER_covariates/gtex_Muscle_Skeletal.txt'
